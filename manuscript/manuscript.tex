...
We propose a set of data curation
principles tailored for government-released open data to address them.
...
of the NYC 311 Service Request (SR) dataset.
 This dataset serves as a prime 
...
processing of the 311 SR data. Second, we propose a set of data 
curation principles tailored for government-released open 
data. These principles address the unique requirements and 
...
adherence to the data dictionary, and missing entries.
...
on the 311 Service Request Data Dictionary.
...
This span of precision could suggest inconsistent data capture. These coordinate 
...
before or after their \texttt{due\_date}, it would be difficult 
...
examined in greater detail later in this section.
...
suggesting automated prepopulation during early procecssing.
...
SR resolutions are statistically improbable. Moreover, 
...
extending for months or years. An analysis was conducted to determine 
appropriate lower-bound thresholds for identifying implausibly 
small duration values. Durations were truncated to
...
\begin{itemize}[left=1.5em, itemsep=0.25\baselineskip, align=parleft, label=\textbullet]
  ...
  similar names, these fields exhibit only a 0.29\% match 
   indicating that these fields appear to serve different purposes. 
...
\begin{itemize}[left=1.5em,itemsep=0.1\baselineskip]
  ...
  83\% match; therefore, retaining a single pair is sufficient.
...
categorical inputs often prevents misspellings and invalid entries, ensuring 
...
shows acceptable values of \textit{address, blockface, intersection, latlong}, 
...
Building on insights from our case study of the NYC 311 SR dataset,
we propose a set of data curation principles tailored for government
open data. These principles address the unique requirements observed
in the management of such data, helping ensure reliability,
consistency, and continued utility for public services, research,
and related applications. To facilitate implementation, the 
principles are prioritized based on their impact and feasibility, 
offering a clear roadmap for improving data curation practices.
...
cross-agency collaboration. To address this, agencies should adopt 
...
actual data. Allowable values should be explicitly documented in the Data Dictionary,
and regular reviews and updates should occur, especially when there
are changes in data structure, usage, or context.
...
inspired by the potential of open data to enhance
 public services. Governments’ support of such initiatives not only 
 promotes data literacy but also encourages community-driven 
 improvements to datasets, strengthens public engagement, and 
 demonstrates the societal value of open data.
...
\textsc{R} source code is available at: \url{https://github.com/tusseyd/nyc_311_data_cleaning}.\\ 
USPS Zip Code dataset is archived on Figshare:
DOI: \url{https://doi.org/10.6084/m9.figshare.31053361}. 
NYC 311 SR dataset is archived on Figshare:
