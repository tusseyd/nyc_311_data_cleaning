...
Figure~\ref{fig:duration-histogram-cumulative} 
and Figure~\ref{fig:duration-histogram-count} visualize the 
...
\caption{Distribution of  Small SR Durations (2--90 seconds) by Count.}
\label{fig:duration-histogram-count}
\end{figure}
