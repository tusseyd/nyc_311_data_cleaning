...
Thus, it is perhaps not unusual to see that one agency 
...
\caption{Distribution of N	egative durations (closed $<$ created date) by agency)}
...
Figure~\ref{fig:duration-histogram} visualizes the 
this suspicious boundary. It shows the overall 
distribution of near-zero duration SRs from 2---90 seconds 
showing durations counts. Of note is the spike at the one-minute 
...
\caption{Create Dates by Seconds Reveals Spikes on Every Minute (mm:00).}
...
\caption{Backlog of SR --- Open at the Beginning of the Year}
...
the \texttt{jds\_datacleansing.R} program, there will be 92 charts in .PDF format in 
...
\vspace{0.1cm}
\begin{itemize}
\item 92 PDF charts in \texttt{charts/}
