...
accompanying discussion (p.~4, ll.~26--30) to state its main takeaway
...
the revised manuscript, p.~4, ll.~32--41) listing the six agencies that together
...
text (p.~12, ll.~12--24). The remaining plot now spans the full page
...
(p.~9, ll.~34--35). The abbreviation arose from the \texttt{siunitx}
...
similar examples (p.~13, ll.~4--8) and to note that such 
...
\centering
\small
\caption{Selected \texttt{complaint\_type}(s) with long average positive durations, by 
agency. Durations are the mean number of days from \texttt{created\_date} to
\texttt{closed\_date} for each \texttt{complaint\_type}.}
